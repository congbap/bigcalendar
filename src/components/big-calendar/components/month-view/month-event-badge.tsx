  ...
  'mx-1 flex size-auto h-6.5 select-none items-center justify-between gap-1.5 truncate whitespace-nowrap rounded-md border px-2 text-xs focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring',
  {
    variants: {
      color: {
        ...
        indigo: 'border-indigo-200 bg-indigo-50 text-indigo-700 dark:border-indigo-800 dark:bg-indigo-950 dark:text-indigo-300 [&_.event-dot]:fill-indigo-600',
        violet: 'border-violet-200 bg-violet-50 text-violet-700 dark:border-violet-800 dark:bg-violet-950 dark:text-violet-300 [&_.event-dot]:fill-violet-600',
        ...
        slate: 'border-slate-200 bg-slate-50 text-slate-900 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-300 [&_.event-dot]:fill-slate-600',
        ...
        stone: 'border-stone-200 bg-stone-50 text-stone-900 dark:border-stone-700 dark:bg-stone-900 dark:text-stone-300 [&_.event-dot]:fill-stone-600',
        ...
        'amber-dot': 'bg-neutral-50 dark:bg-neutral-900 [&_.event-dot]:fill-amber-600',
        'yellow-dot': 'bg-neutral-50 dark:bg-neutral-900 [&_.event-dot]:fill-yellow-600',
        'lime-dot': 'bg-neutral-50 dark:bg-neutral-900 [&_.event-dot]:fill-lime-600',
        'green-dot': 'bg-neutral-50 dark:bg-neutral-900 [&_.event-dot]:fill-green-600',
        'emerald-dot': 'bg-neutral-50 dark:bg-neutral-900 [&_.event-dot]:fill-emerald-600',
        'teal-dot': 'bg-neutral-50 dark:bg-neutral-900 [&_.event-dot]:fill-teal-600',
        'cyan-dot': 'bg-neutral-50 dark:bg-neutral-900 [&_.event-dot]:fill-cyan-600',
        'sky-dot': 'bg-neutral-50 dark:bg-neutral-900 [&_.event-dot]:fill-sky-600',
        'blue-dot': 'bg-neutral-50 dark:bg-neutral-900 [&_.event-dot]:fill-blue-600',
        'indigo-dot': 'bg-neutral-50 dark:bg-neutral-900 [&_.event-dot]:fill-indigo-600',
        'violet-dot': 'bg-neutral-50 dark:bg-neutral-900 [&_.event-dot]:fill-violet-600',
        'purple-dot': 'bg-neutral-50 dark:bg-neutral-900 [&_.event-dot]:fill-purple-600',
        'fuchsia-dot': 'bg-neutral-50 dark:bg-neutral-900 [&_.event-dot]:fill-fuchsia-600',
        'pink-dot': 'bg-neutral-50 dark:bg-neutral-900 [&_.event-dot]:fill-pink-600',
        'rose-dot': 'bg-neutral-50 dark:bg-neutral-900 [&_.event-dot]:fill-rose-600',
        'slate-dot': 'bg-neutral-50 dark:bg-neutral-900 [&_.event-dot]:fill-slate-600',
        'gray-dot': 'bg-neutral-50 dark:bg-neutral-900 [&_.event-dot]:fill-gray-600',
        'zinc-dot': 'bg-neutral-50 dark:bg-neutral-900 [&_.event-dot]:fill-zinc-600',
        'neutral-dot': 'bg-neutral-50 dark:bg-neutral-900 [&_.event-dot]:fill-neutral-600',
